...
export const km = {
  ...
  networkError: 'បញ្ហាបច្ចេកទេស។ សូមព្យាយាមម្តងទៀត។',
  networkErrorDesc: 'គ្មានការឆ្លើយតបក្នុងការតភ្ជាប់ពីម៉ាស៊ីនមេ សូមព្យាយាមម្តងទៀត ឬធ្វើបច្ចុប្បន្នភាព Browser របស់លោកអ្នក។',
  connectionError: 'បញ្ហាការតភ្ជាប់។ សូមព្យាយាមម្តងទៀត។',
  ...
  setup2FA: 'ផ្ទៀងផ្ទាត់សុវត្ថិភាព២ជាន់',
  twoFARecommendation: 'Two-factor authentication (2FA) ជាប្រភេទនៃការការពារសុវត្ថិភាពគណនីរបស់អ្នក ពីលើមួយជាន់ទៀត ដូចនេះអ្នកត្រូវការលេខកូដផ្ទៀងផ្ទាត់ពីរទូរស័ព្ទរបស់អ្នក',
  secureYourAccount: 'ការពារសុវត្ថិភាពគណនីរបស់អ្នក',
  twoFASubTitle: 'គ្រប់គ្រងគណនីរបស់អ្នក ជាមួយការការពារសុវត្ថិភាពពីរជាន់ Two-factor authentication (2FA)',
  twoFAStep1: 'ស្កេន QR Code របស់អ្នកជាមួយនឹងកម្មវិធីលើទូរស័ព្ទដៃដូចជា៖ Google Authenticator, Authy',
  twoFAStep2: 'បន្ទាត់មកវាយលេខកូដ ដែលបង្ហាញក្នុងកម្មវិធីលើទូរស័ព្ទរបស់អ្នក',
  verifyAndEnable: 'ផ្ទៀងផ្ទាត់ និង អនុវត្ត',
  verifying: 'កំពុងផ្ទៀងផ្ទាត់',
  twoFactorAuth: 'សុវត្ថិភាពពីរជាន់',
  verificationFailed: 'ការផ្ទៀងផ្ទាត់បានបរាជ័យ',
  twoFAEnabled: 'ការការពារសុវត្ថិភាពពីរជាន់បានអនុវត្ត',
  twoFAEnabledDescription: 'បច្ចុប្បន្ននេះគណនីរបស់អ្នកមានការការពារសុវត្ថិភាពពីរជាន់',
  disable2FA: 'បិទការការពារសុវត្ថិភាពពីរជាន់',
  disable2FAConfirm: 'តើអ្នកប្រាកដថាចង់បិទការការពារសុវត្ថិភាពពីរជាន់ទេ? គណនីរបស់អ្នកនឹងមិនមានការការពារសុវត្ថិភាពពីរជាន់',
  verificationFailed: 'ការផ្ទៀងផ្ទាត់បានបរាជ័យ',
  twoFAErrorMessage: 'លេខកូដផ្ទៀងផ្ទាត់មិនត្រឹមត្រូវ ឬផុតសុពលភាព, សូមព្យាយាមម្តងទៀត',
  twoFAEnabledSuccess: 'ការការពារសុវត្ថិភាពពីរជាន់បានអនុវត្តជោគជ័យ',
  twoFADisabledSuccess: 'ការការពារសុវត្ថិភាពពីរជាន់បានបិទជោគជ័យ',
  failedToGenerateQR: 'បរាជ័យក្នុងការបង្ហាញ QR Code',
  ...
  teacherFamily: 'ព័ត៌មានគ្រួសារ',
  repeated_class_info: 'បានឆ្លងកាត់ថ្នាក់មត្តេយ្យ',
  repeatedClassInfo: 'បានឆ្លងកាត់ថ្នាក់មត្តេយ្យ',
  repeated_grade_info: 'បានឆ្លងកាត់ថ្នាក់មត្តេយ្យ',
  repeatedGradeInfo: 'បានឆ្លងកាត់ថ្នាក់មត្តេយ្យ',
  weightKg: 'ទម្ងន់',
  heightCm: 'កម្ពស់',
  livingStatus: 'ស្ថានភាពរស់នៅ',
  spouseInfo: 'ព័ត៌មានប្ដី/ប្រពន្ធ',
  bmi: 'BMI',
  // Category translations for data completion page
  baseFields: 'ទិន្នន័យមូលដ្ឋាន',
  teacherSpecific: 'ព័ត៌មានលម្អិតគ្រូ',
  teacherSpecificInfo: 'ព័ត៌មានលម្អិតគ្រូ',
  studentSpecific: 'ព័ត៌មានលម្អិតសិស្ស',
  locationInfo: 'ទីតាំង',
  familyInfo: 'គ្រួសារ',
  physicalInfo: 'រាងកាយ',
  ...
  incompletScores: 'សូមបំពេញឯកសារលម្អិតទាំងអស់។ ពិន្ទុដែលបាត់សម្រាប់:',
  andMore: 'និង',
  more: 'ច្ចាប់ផ្សេងទៀត',
  ...
  examScoreTemplates: 'គំរូពិន្ទុប្រលង',
  templateManagement: 'ការគ្រប់គ្រងគំរូ',
  scoreInputTemplate: 'បញ្ចូលពិន្ទុតាមគំរូ',
  createTemplate: 'បង្កើតគំរូ',
  editTemplate: 'កែប្រែគំរូ',
  deleteTemplate: 'លុបគំរូ',
  templateName: 'ឈ្មោះគំរូ',
  enterTemplateName: 'បញ្ចូលឈ្មោះគំរូ',
  gradeLevel: 'កម្រិតថ្នាក់',
  ...
  templateAppliedSuccess: 'គំរូត្រូវបានអនុវត្តដោយជោគជ័យ។ បានបង្កើត: {{created}}, រំលង: {{skipped}}',
  noTemplateApplied: 'មិនទាន់មានគំរូត្រូវបានអនុវត្ត',
  noTemplateAppliedDesc: 'មិនមានគំរូត្រូវបានអនុវត្តទៅថ្នាក់នេះសម្រាប់ខែ និងឆ្នាំដែលបានជ្រើសរើស។ សូមអនុវត្តគំរូជាមុនសិន។',
  myTemplates: 'គំរូរបស់ខ្ញុំ',
  noTemplates: 'មិនមានគំរូ',
  noTemplatesDesc: 'បង្កើតគំរូដំបូងរបស់អ្នកដើម្បីចាប់ផ្តើម',
  creatingTemplate: 'កំពុងបង្កើតគំរូ...',
  updatingTemplate: 'កំពុងកែប្រែគំរូ...',
  deletingTemplate: 'កំពុងលុបគំរូ...',
  applyingTemplate: 'កំពុងអនុវត្តគំរូ...',
  templateCreated: 'គំរូត្រូវបានបង្កើតដោយជោគជ័យ',
  templateUpdated: 'គំរូត្រូវបានកែប្រែដោយជោគជ័យ',
  templateDeleted: 'គំរូត្រូវបានលុបដោយជោគជ័យ',
  errorCreatingTemplate: 'បរាជ័យក្នុងការបង្កើតគំរូ',
  errorUpdatingTemplate: 'បរាជ័យក្នុងការកែប្រែគំរូ',
  errorDeletingTemplate: 'បរាជ័យក្នុងការលុបគំរូ',
  errorApplyingTemplate: 'បរាជ័យក្នុងការអនុវត្តគំរូ',
  errorFetchingTemplates: 'បរាជ័យក្នុងការទាញយកគំរូ',
  confirmDeleteTemplate: 'តើអ្នកប្រាកដថាចង់លុបគំរូនេះទេ?',
  fillAllFields: 'សូមបំពេញវាលទាំងអស់ និងបន្ថែមមុខវិជ្ជាយ៉ាងហោចណាស់មួយ',
  manageTemplatesAndScores: 'គ្រប់គ្រងគំរូពិន្ទុ និងបញ្ចូលពិន្ទុសិស្ស',
  loadingTemplates: 'កំពុងទាញយកគំរូ...',
  loadingScores: 'កំពុងទាញយកពិន្ទុ...',
  errorFetchingScores: 'បរាជ័យក្នុងការទាញយកពិន្ទុ',
  savingScore: 'កំពុងរក្សាទុកពិន្ទុ...',
  savingAllScores: 'កំពុងរក្សាទុកពិន្ទុទាំងអស់...',
  scoreSaved: 'ពិន្ទុត្រូវបានរក្សាទុកដោយជោគជ័យ',
  allScoresSaved: 'ពិន្ទុទាំងអស់ត្រូវបានរក្សាទុកដោយជោគជ័យ',
  errorSavingScore: 'បរាជ័យក្នុងការរក្សាទុកពិន្ទុ',
  selectClassToViewScores: 'សូមជ្រើសរើសថ្នាក់ពីតម្រងដើម្បីមើលពិន្ទុ',
  totalStudents: 'សិស្សសរុប',
  totalColumns: 'ជួរឈរសរុប',
  totalScores: 'ពិន្ទុសរុប',
