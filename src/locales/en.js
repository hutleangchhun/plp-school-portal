...
export const en = {
 ...
 //report
  ...
  manageYourSchedule: 'Manage your teaching schedule for the week',
  addSchedule: 'Add Schedule',
  editSchedule: 'Edit Schedule',
  deleteSchedule: 'Delete Schedule',
  scheduleDetails: 'Schedule Details',
  confirmDeleteSchedule: 'Are you sure you want to delete this schedule?',
  deleteScheduleConfirm: 'Are you sure you want to delete this schedule? This action cannot be undone.',
  ...
  scheduleConflict: 'Schedule conflict detected. Please choose a different time.',
  ...
  dayRequired: 'Day of week is required',
  ...
  locationPlaceholder: 'e.g. Building A',
  ...
  newScheduleFor: 'New Schedule for:',
  notSelected: 'Not selected',
  notAvailable: 'N/A',
  schoolSchedule: 'School Schedule',
  viewAllSchedules: 'View all class schedules by grade level',
