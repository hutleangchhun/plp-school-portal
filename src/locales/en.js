...
export const en = {
  ...
  selectClassForReport1: 'Please select a specific class to generate the report',
  selectClassForReport4: 'Please select a specific class for the absence report',
  noDataMessage: 'Please select filters and wait for data to load.',
  withBMI: 'With BMI',
  withoutBMI: 'Without BMI',
  avgBMI: 'Avg BMI',
  studentsWithDisability: 'Students with Disability',
  daysRecorded: 'Days Recorded',
  bmiStatusBreakdown: 'BMI Status Breakdown',
  thinnessG3: 'Thinness G3',
  thinnessG2: 'Thinness G2',
  thinnessG1: 'Thinness G1',
  normalBMI: 'Normal',
  overweight: 'Overweight',
  obesity: 'Obesity',
  byDisabilityType: 'By Disability Type',
  byEthnicGroup: 'By Ethnic Group',
  noBreakdownData: 'No breakdown data',
  noMinorityBreakdown: 'No minority breakdown data',
  present: 'Present',
  absent: 'Absent',
  late: 'Late',
  leave: 'Leave',
  highestFrequencyRecords: 'Highest Frequency Records',
  topPresent: 'Top Present',
  topAbsent: 'Top Absent',
  topLate: 'Top Late',
  topLeave: 'Top Leave',
  ...
  toolPackageTotal: 'Total Students with Packages by Tool',
  totalWithPackages: 'Total with Packages',
  ...
  toolName: 'Extra Learning Tool Name',
  field: 'Field',
  providerName: 'Provider',
  statusCount: 'Count',
  statusPercentage: 'Percentage',
  providerBreakdown: 'Provider Breakdown',
  statusAndProviderBreakdown: 'Status & Provider Breakdown by Tool',
  statusBreakdown: 'Status Breakdown',
  oldYear: 'Old Year',
  newYear: 'New Year',
  schoolProvided: 'School Provided',
  parentPurchased: 'Parent Purchased',
  unspecified: 'Unspecified',
  withPackages: 'Students with Learning Packages',
  withoutPackages: 'Students without Learning Packages',
  coverage: 'Coverage',
  poorCardGrade: 'Poor Card Grade',
  poorCardGradeDistribution: 'Poor Card Grade Distribution',
  studentsWithGradeOne: 'Students with Grade 1',
  studentsWithGradeTwo: 'Students with Grade 2',
  studentsWithGradeRisk: 'Students with Grade Risk',
  gradeOne: 'Grade 1',
  gradeTwo: 'Grade 2',
  gradeRisk: 'Risk',
  poorCardGradeBreakdown: 'Poor Card Grade Breakdown',
  failedToLoadPoorCardStats: 'Failed to load poor card grade statistics',
  grade: 'Grade',
  kindergartenStatistics: 'Kindergarten Statistics',
  kindergartenStudents: 'Kindergarten Students',
  nonKindergartenStudents: 'Non-Kindergarten Students',
  kindergartenPercentage: 'Kindergarten %',
  kindergartenDistribution: 'Kindergarten Distribution',
  studentTypeBreakdown: 'Student Type Breakdown',
  kindergarten: 'Kindergarten',
  nonKindergarten: 'Non-Kindergarten',
  failedToLoadKindergartenStats: 'Failed to load kindergarten statistics',
  totalAllStudents: 'Total All Students',
  studentAcademicMetrics: 'Student Academic Metrics',
  poorCardGradeStatistics: 'Poor Card Grade Statistics',
  ...
  height: 'Height',
  bmi: 'BMI',
  repeated_class_info: 'Passed Kindergarten Class',
  repeatedClassInfo: 'Passed Kindergarten Class',
  repeated_grade_info: 'Passed Kindergarten Class',
  repeatedGradeInfo: 'Passed Kindergarten Class',
  weightKg: 'Weight',
  heightCm: 'Height',
  age: 'Age',
  ...
  schoolAttendanceList: 'School Attendance',
  schoolAttendanceListDesc: 'View attendance records for each school',
  attendanceDetails: 'Attendance Details',
  studentRecords: 'Student Records',
  teacherRecords: 'Teacher Records',
  totalRecords: 'Total Records',
  withStudentData: 'With Student Data',
  withTeacherData: 'With Teacher Data',
  totalAttendance: 'Total Attendance',
  schoolAttendanceNote: 'This shows the total number of attendance records for this school. For detailed attendance reports, please navigate to the main attendance overview page.',
  ...
  schoolManagement: 'School Staff Management System',
  ...
  studentDemographics: 'Student Demographics',
  viewStudentDemographics: 'View student ethnic groups and accessibility needs across all schools',
  userDemographics: 'User Demographics',
  viewUserDemographics: 'View user ethnic groups and accessibility needs across all schools',
  selectRole: 'Select Role',
  filterByRole: 'Select role to filter demographics data',
  searchRole: 'Search role...',
  teacherDemographics: 'Teacher Demographics',
  viewTeacherDemographics: 'View teacher ethnic groups and accessibility needs across all schools',
  ...
  failedToUpdateSchool: 'Failed to update school',
  failedToDeleteSchool: 'Failed to delete school',
  manageSchools: 'Manage Schools',
  loadingSchools: 'Loading schools...',
  errorFetchingSchools: 'Failed to fetch schools',
  noSchoolsFound: 'No schools found',
  schoolName: 'School Name',
  schoolCode: 'School Code',
