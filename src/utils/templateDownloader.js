...
export const templateDownloader = async (schoolId = null) => {
  ...
  const templateData = [
    ...
    [
      ...
      'អាសយដ្ឋានពេញ',
      'នាម', 'គោត្តនាម', 'ទូរស័ព្ទ', /* Father gender column hidden */ '', 'មុខរបរ', 'អាសយដ្ឋានពេញឪពុក',
      'នាម', 'គោត្តនាម', 'ទូរស័ព្ទ', /* Mother gender column hidden */ '', 'មុខរបរ', 'អាសយដ្ឋានពេញម្តាយ',
